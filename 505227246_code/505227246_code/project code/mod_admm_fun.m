function [x,iter] = mod_admm_fun(y,H,T,Q,K,N,M,SNR,lam,max_iter,tolerance)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
while (norm(r,'fro') > tolerance || norm (s,'fro') > tolerance) && max_iter >= iter
% while max_iter >= iter
...
%     size(r)
%     size(s)
    r_store(iter) = norm(r,'fro');
    s_store(iter) = norm(s,'fro');
    %%%%%%%%%%%%%%%%%% step-11 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    for t =1:T
