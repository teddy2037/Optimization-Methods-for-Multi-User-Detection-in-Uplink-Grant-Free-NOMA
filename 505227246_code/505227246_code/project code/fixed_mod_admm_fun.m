function [x,iter] = fixed_mod_admm_fun(y,H,T,Q,K,N,M,SNR,lam,max_iter,tolerance)
...
% while max_iter >= iter
    ...
    for t = 1:T
        %%%%%%%%%%%%%%% step-4 %%%%%%%%%%%%
        x_current(:,t) = V(:,:,t)*inv(L(:,:,t)+(row(t) + alpha_prev(t,1))*eye(2*K))*V(:,:,t)'*(eff(:,:,t) + alpha_prev(t,1)*x_prev_hat(:,t) + row(t)*(z_prev(:,t)-u_prev(:,t)));
