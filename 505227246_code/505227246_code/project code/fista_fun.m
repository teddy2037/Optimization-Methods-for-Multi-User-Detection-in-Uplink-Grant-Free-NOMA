function [x,iter] = fista_fun(y,H,T,Q,K,N,M,SNR,lam,max_iter,tolerance)
...
%       eigval(t,1) = 1/max(eig(AtA(:,:,t)));
    ...
    grad_y = zeros(2*K,T);
    %%%%%%%%%%%%%%%%%%%% step-3 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        theta_current = (sqrt( (theta_prev)^2 + 4*theta_prev )-theta_prev )/2;
    for t = 1:T
        
        y_current(:,t) = x_prev(:,t) + theta_current*((1/theta_prev) - 1)*(x_prev(:,t) - x_prev_prev(:,t));
        %%%%%%%%%%%%%%% step-4 %%%%%%%%%%%%
