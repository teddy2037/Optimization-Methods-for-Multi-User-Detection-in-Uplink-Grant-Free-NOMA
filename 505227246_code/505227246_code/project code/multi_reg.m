...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tic
x_recv = admm_fun(y,Htrans,T,Q,K,N,M,SNR,lam,max_iter,tolerance);
toc
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tic
x_recv = mod_admm_fun(y,Htrans,T,Q,K,N,M,SNR,lam,max_iter,tolerance);
toc
xdec = decode_main(x_recv,T,M,K); 
ber = ber_main(xenc,xdec,T,K);  
d = ['ber: ',num2str(ber)];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tic
x_recv = f_admm_fun(y,Htrans,T,Q,K,N,M,SNR,lam,max_iter,tolerance);
toc
xdec = decode_main(x_recv,T,M,K); 
ber = ber_main(xenc,xdec,T,K);  
d = ['ber: ',num2str(ber)];
